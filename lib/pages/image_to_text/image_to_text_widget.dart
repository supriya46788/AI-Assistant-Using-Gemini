...
import 'image_to_text_model.dart';
export 'image_to_text_model.dart';

class ImageToTextWidget extends StatefulWidget {
  const ImageToTextWidget({super.key});

  static String routeName = 'imageToText';
  static String routePath = '/imageToText';

  @override
  State<ImageToTextWidget> createState() => _ImageToTextWidgetState();
}

class _ImageToTextWidgetState extends State<ImageToTextWidget> {
  late ImageToTextModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ImageToTextModel());
              ...
              children: [
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          if (selectedMedia != null &&
                            ...
                            safeSetState(() =>
                                _model.isDataUploading_uploadDataH4m = true);
                            ...
                            try {
                              ...
                              _model.isDataUploading_uploadDataH4m = false;
                            }
                            if (selectedUploadedFiles.length ==
                                selectedMedia.length) {
                              safeSetState(() {
                                _model.uploadedLocalFile_uploadDataH4m =
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(10.0, 12.0, 5.0, 10.0),
                      child: Text(
